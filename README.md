...
```
java -cp "target/classes:target/libs/*" com.github.russp.jtorrt.WebClientMain PORT
```
...
```
docker build -t jtorrt .
```

## Running the Docker Image

```
docker run --rm -p 8080:8080 jtorrt:latest
```
